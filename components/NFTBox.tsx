...
import nftPerksAbi1 from "../constants/NftPerks1.json";
import nftPerksAbi2 from "../constants/NftPerks2.json";
import nftPerksAbi3 from "../constants/NftPerks3.json";
import fundABizAbi from "../constants/FundABusiness.json";
